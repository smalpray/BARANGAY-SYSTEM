...
<div className="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm">
        ...
        <div className="divide-y divide-gray-200">
          {filteredOfficials.map((official, index) => (
            <div key={official.id} className={`grid grid-cols-12 gap-4 px-4 py-3 items-center ${index % 2 === 0 ? 'bg-white' : 'bg-gray-50'} hover:bg-blue-50 transition-colors`}>
              ...
              <div className="col-span-2">
                <span className={`px-3 py-1 rounded-full text-white text-xs font-medium ${official.positionColor}`}>
                  {official.position}
                </span>
              </div>
              <div className="col-span-2 text-sm text-gray-700">{official.officialNumber}</div>
              <div className="col-span-2 text-sm font-medium text-gray-900">{official.name}</div>
              <div className="col-span-1">
                <span className="px-2 py-1 rounded text-xs font-medium bg-yellow-100 text-yellow-800">{official.pwd}</span>
              </div>
              <div className="col-span-1">
                <span className="px-2 py-1 rounded text-xs font-medium bg-yellow-100 text-yellow-800">{official.singleParent}</span>
              </div>
              <div className="col-span-1">
                <span className="px-2 py-1 rounded text-xs font-medium bg-green-100 text-green-800">{official.voters}</span>
              </div>
              <div className="col-span-1">
